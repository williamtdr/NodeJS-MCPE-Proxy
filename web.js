...
{
	console.log('Received post request for web server to transfer player: ' + fields.username);
    ...
    utils.config.emit(
    	...
    	function(code)
	    {
	    	...
	    	{
	    		case 200:
	    			var body = {"transferred":true, "message":"Successful transfer."};
	    			break;
	    		
	    		case 400:
	    			var body = {"transferred":false, "message":"External error. Transfer failed."};
	    			break;
	    		
	    		case 500:
	    			var body = {"transferred":false, "message":"Internal error. Transfer failed."};
	    			break;
	    	}
			res.writeHead(
				code,
